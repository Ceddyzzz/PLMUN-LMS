<?php
// This file is included, session already started in dashboard.php
...
<body class="bg-gray-100">
  ...
  <main class="p-6 max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
      ...
      <a href="chat.php" class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition cursor-pointer transform hover:scale-105">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="space-y-2">
          ...
          <a href="chat.php" class="block p-3 bg-orange-50 rounded hover:bg-orange-100 transition cursor-pointer">
            💬 Message Prof & Student
          </a>
        </div>
      </div>
